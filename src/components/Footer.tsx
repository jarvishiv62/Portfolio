...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/jarvishiv62',
    icon: (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold text-white mb-4">Utkarsh Maurya</h3>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">
              © {currentYear} Utkarsh Maurya. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <p className="text-xs text-gray-500">
                Made with <span className="text-pink-500">❤️</span> using Next.js & Tailwind CSS
              </p>
            </div>
          </div>
        </div>
